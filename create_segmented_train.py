...
def create_segmented_csv(direc_path, train_path, tennis_path):
...
def main():
    ...
    train_path = "/cluster/tufts/cs152l3dclass/oeiels01/train.csv"
    tennis_path = "/cluster/tufts/cs152l3dclass/oeiels01/tennis"

    create_segmented_csv(direc_path, train_path, tennis_path)
